...
function Header() {
  ...
  return (
    <header
      className={`bg-[#612503] bg-[39%]  py-6 px-4 sm:px-6 lg:px-8 shadow-md shadow-[rgba(0,0,0,0.5)] fixed top-0 w-full transition-all duration-300 ${
    ...
    > <div className="flex items-center justify-between">
        ...
        <button className="lg:hidden block text-3xl" onClick={() => setIsMenuOpen(!isMenuOpen)}>
          &#9776;
        </button>
      </div>
    </header>
