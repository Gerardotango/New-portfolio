    ...
    <section className="bg-white md:h-[40rem] flex justify-center items-center py-12 md:py-0">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-row justify-center">
          <div className="flex flex-row justify-center">
            <div className="bg-orange-900 rounded-l-[1.5rem] md:w-2/3 lg:w-1/2 p-6 md:p-8">
              <form onSubmit={handleSubmit} className="sm:mr-4 ml-4 mt-8 mb-8 bg-orange-900 pt-6">
                ...
                <button
                  type="submit"
                  className="bg-black hover:bg-white hover:text-black text-white  font-inter font-semibold py-2 px-4 rounded-full w-full"
                >
                  Envoyer
                </button>
              </form>
            </div>
            <div className="bg-orange-900 rounded-r-[1.5rem] md:w-2/3 lg:w-1/2 p-6 md:p-8 flex flex-col justify-center items-center">
